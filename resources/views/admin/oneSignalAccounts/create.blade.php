        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.oneSignalAccount.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.one-signal-accounts.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('user_auth_key') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="user_auth_key" id="user_auth_key" value="{{ old('user_auth_key', '') }}" required>
