...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // One Signal Account
    Route::delete('one-signal-accounts/destroy', 'OneSignalAccountController@massDestroy')->name('one-signal-accounts.massDestroy');
    Route::resource('one-signal-accounts', 'OneSignalAccountController');
